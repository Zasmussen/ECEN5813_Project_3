...
#
SRCS = main.c  conversion.c data.c debug.c project1.c project2.c project3.c memory.c  circbuf.c

# Add in KL25Z files if platform is set to it
ifeq ($(PLATFORM),KL25Z)
	SRCS += system_MKL25Z4.c startup_MKL25Z4.S arch_arm32.c GPIO.c UART.c spi.c
endif
ifeq ($(PLATFORM),HOST)
	SRCS += tests.c
endif
